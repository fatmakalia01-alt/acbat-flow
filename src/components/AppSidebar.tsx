...
const menuItems = [
  ...
  { icon: ClipboardCheck, label: "Suivi Commandes", path: "/tracking", roles: ["manager", "directeur_exploitation", "responsable_commercial", "commercial", "responsable_achat", "responsable_logistique", "responsable_technique", "technicien_montage", "responsable_sav", "responsable_comptabilite", "livraison", "client"] },
